...
class DataLoading:
    ...
    def load_data(self):
        ...
        train_set = torchvision.datasets.ImageFolder(root=r"C:\Users\Surface\Training_assignment_03\Training",
        ...
        test_set = torchvision.datasets.ImageFolder(root=r"C:\Users\Surface\Test_assignment_03\Test",
                                                    transform=torchvision.transforms.Compose(
                                                        [torchvision.transforms.ToTensor(),
                                                         torchvision.transforms.Resize((100, 100)),
                                                         torchvision.transforms.Normalize((0.5, 0.5, 0.5),
